function est = run_phd_filter(model,meas)

% This is the MATLAB code for the GM-PHD filter 
...
for k=1:meas.K
    ...
    w_update = model.Q_D*w_predict; % remember that model.Q_D is miss detection prob
    m_update = m_predict;
    P_update = P_predict;
