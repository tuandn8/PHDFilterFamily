...
% detail about model in "A survey on Maneuvering target tracking 
% part I Dynamic models", 2000, X.Rong Li, Vesselin P. Jilkov
% CV model has transition matrix F and process noise cov Q in the form
% F = [1 T 0 0
%      0 1 0 0
%      0 0 1 T
%      0 0 0 1]
...
% clutter parameters
model.lambda_c= 40;                             %poisson average rate of uniform clutter (per scan)
