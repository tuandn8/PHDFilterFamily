...
% xstart(:,1)  = [ -600; 4; -600; 4 ];        tbirth(1)  = 1;     tdeath(3)  = 70;
% xstart(:,2)  = [ 300; -14; 400; -4 ];       tbirth(2)  = 1;     tdeath(4)  = truth.K+1;
% xstart(:,3)  = [ 300;  6; 400; -16 ];       tbirth(3)  = 1;     tdeath(5)  = truth.K+1;
% 
% xstart(:,4)  = [ -600; 30; -600; 5 ];       tbirth(4)  = 10;    tdeath(1)  = 70;
% xstart(:,5)  = [ -600; 5; -600; 20 ];       tbirth(5)  = 10;    tdeath(2)  = truth.K+1;
% xstart(:,6)  = [ 200; -20; -800; 30 ];      tbirth(6)  = 10;    tdeath(8)  = truth.K+1;
% 
% xstart(:,7)  = [ 200; 10; -800; -10 ];      tbirth(7)  = 30;    tdeath(7)  = truth.K+1;
% xstart(:,8)  = [ 200; -5; -800; 0 ];        tbirth(8)  = 30;    tdeath(9)  = truth.K+1;
% xstart(:,9)  = [ 300; -5; 400; -5 ];        tbirth(9)  = 40;    tdeath(6)  = truth.K+1;
% 
% xstart(:,10) = [ -500; 5; 500; -5 ];       tbirth(10) = 40;    tdeath(10) = truth.K+1;
